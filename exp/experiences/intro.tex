...
L'\nameref{expD3} est intéressante, elle montre qu'il est possible pour une architecture de ``monitorer'' son comportement de manière à influencer les parmètres d'apprentissage pour augmenter les performances. [en ce qui me concerne, faudrait que je comprenne un peu mieux l'influence du momentum].
