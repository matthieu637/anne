...
if __name__ == '__main__':
    ...
    plt.plot(display_interval , y_plot['first_order'][3::5], label="first-order network")
    plt.plot(display_interval , y_plot['high_order_h'][3::5], label="high-order network (high learning rate)")
    ...
    plt.plot(display_interval , y_perfo['high_order_l'][3::5], label="high-order network (low learning rate)")
