...
if __name__ == '__main__':
    ...
    for i in range(nbr_network):
        ...
        feedback = [PerceptronR0to1(20 + 8, 0.1, 0., True) for _ in range(10)]
    ...
    for epoch in range(nbEpoch):
        ...
        for network in networks:
            ...
            for ex in l_exx[0:nbTry]:
                ...
                res = [ network['feedback'][i].calc_output(ampli(network['high_order_h'].stateOutputNeurons, 8) +
                ...
                #learn
                for i in range(10):
                    network['feedback'][i].train(ampli(network['high_order_h'].stateOutputNeurons, 8) +
    ...
    plt.title("Feedback with a third perceptron network ( output SoN hidden SoN )")
