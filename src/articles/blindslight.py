...
#    samples.inputs = samples.inputs[0:100]
    ...
    first_order = MultilayerNetwork(100, 60, 100, 0, 0.9, 0.4, 2., False, True)
...
#            rms_ss2 += first_order.calc_RMS(samples.inputs[ex], samples.outputs[ex])
...
#        print(first_order.stateOutputNeurons)
#        print(res33, high_order[0].bias, sum(compara))
